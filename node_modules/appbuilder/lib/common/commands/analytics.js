...
class ErrorReportingCommand extends AnalyticsCommand {
    ...
    execute(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const shouldRestartEqatecMonitor = this.$staticConfig.ANALYTICS_EXCEPTIONS_API_KEY && (yield this.$analyticsService.isEnabled(this.$staticConfig.TRACK_FEATURE_USAGE_SETTING_NAME));
            if (shouldRestartEqatecMonitor) {
                yield this.$analyticsService.restartEqatecMonitor(this.$staticConfig.ANALYTICS_EXCEPTIONS_API_KEY);
            }
