...
function resolveCallStack(error) {
    ...
    let parsed = _.map(stackLines, (line) => {
    ...
    let remapped = _.map(parsed, (parsedLine) => {
        ...
        let consumer = new source_map_1.SourceMapConsumer(mapData);
...
function installUncaughtExceptionListener(actionOnException) {
    let handler = (err) => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    beginCommand(action, printCommandHelp) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let loggerLevel = $injector.resolve("logger").getLevel().toUpperCase();
