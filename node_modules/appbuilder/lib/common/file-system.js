...
let FileSystem = FileSystem_1 = class FileSystem {
    ...
    setCurrentUserAsOwner(path, owner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.$injector.resolve("$hostInfo").isWindows) {
                let chown = $childProcess.spawn("chown", ["-R", owner, path], { stdio: "ignore", detached: true });
    ...
    getFileShasum(fileName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                fileStream.on("end", () => {
                    let shasum = shasumData.digest(encoding);
    ...
    getIndentationCharacter(filePath) {
        ...
        let matches = fileContent.match(FileSystem_1.JSON_OBJECT_REGEXP);
