...
class Yok {
                    ...
                    if (!fullCommandName) {
                        ...
                        if (defaultCommand) {
                            if (defaultCommand.canExecute) {
                                return yield defaultCommand.canExecute(commandArguments);
                            }
    ...
    register(name, resolver, shared) {
        ...
        let dependency = this.modules[name] || {};
    ...
    getRegisteredCommandsNames(includeDev) {
        let modulesNames = _.keys(this.modules);
        let commandsNames = _.filter(modulesNames, moduleName => _.startsWith(moduleName, `${this.COMMANDS_NAMESPACE}.`));
