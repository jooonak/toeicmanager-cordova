    ...
    getCommandLineHelpForCommand(commandName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const commandLineHelp = (yield this.$microTemplateService.parseContent(helpText, { isHtml: false }))
                ...
                .replace(HtmlHelpService.SPAN_REGEX, (matchingSubstring, textBeforeSpan, textInsideSpan, index, fullString) => {
                return textBeforeSpan + textInsideSpan.replace(this.newLineRegex, "");
            })
                .replace(HtmlHelpService.NEW_LINE_REGEX, os_1.EOL);
...
HtmlHelpService.SPAN_REGEX = /([\s\S]*?)(?:\r?\n)?<span.*?>([\s\S]*?)<\/span>(?:\r?\n)*/g;
HtmlHelpService.NEW_LINE_REGEX = /<\/?\s*?br\s*?\/?>/g;
