...
class XcodeSelectService {
    ...
    getDeveloperDirectoryPath() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let childProcess = yield this.$childProcess.spawnFromEvent("xcode-select", ["-print-path"], "close", {}, { throwError: false }), result = childProcess.stdout.trim();
            if (!result) {
    ...
    getXcodeVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let xcodeVer = yield sysInfoBase.getXCodeVersion();
            if (!xcodeVer) {
                this.$errors.failWithoutHelp("xcodebuild execution failed. Make sure that you have latest Xcode and tools installed.");
            }
            let xcodeVersionMatch = xcodeVer.match(/Xcode (.*)/), xcodeVersionGroup = xcodeVersionMatch && xcodeVersionMatch[1], xcodeVersionSplit = xcodeVersionGroup && xcodeVersionGroup.split(".");
            return {
