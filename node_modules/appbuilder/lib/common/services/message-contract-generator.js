...
class MessageContractGenerator {
    ...
    generate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let messagesClass = new code_entity_1.Block("export class Messages implements IMessages");
            let messagesInterface = new code_entity_1.Block("interface IMessages");
            _.each(this.$messagesService.pathsToMessageJsonFiles, jsonFilePath => {
                let jsonContents = this.$fs.readJson(jsonFilePath), implementationBlock = new code_entity_1.Block(), interfaceBlock = new code_entity_1.Block();
    ...
    generateFileRecursive(jsonContents, propertyValue, block, depth, options) {
        _.each(jsonContents, (val, key) => {
            let newPropertyValue = propertyValue + key, separator = options.shouldGenerateInterface || depth ? ":" : "=", endingSymbol = options.shouldGenerateInterface || !depth ? ";" : ",";
            ...
            let newBlock = new code_entity_1.Block(`${key} ${separator} `);
