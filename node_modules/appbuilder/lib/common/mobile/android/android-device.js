...
class AndroidDevice {
    ...
    getApplicationInfo(applicationIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            let files = yield this.fileSystem.listFiles(constants.LiveSyncConstants.ANDROID_FILES_PATH, applicationIdentifier), androidFilesMatch = files.match(/(\S+)\.abproject/), result = null;
    ...
    getType() {
        return __awaiter(this, void 0, void 0, function* () {
            let runningEmulators = yield this.$androidEmulatorServices.getAllRunningEmulators();
