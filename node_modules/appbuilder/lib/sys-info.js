...
class SysInfo extends sys_info_base_1.SysInfoBase {
    constructor($childProcess, $hostInfo, $iTunesValidator, $logger, $winreg, $staticConfig, $androidEmulatorServices) {
    ...
    getSysInfo(pathToPackageJson, androidToolsInfo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return _super("getSysInfo").call(this, pathToPackageJson || (yield this.$staticConfig.pathToPackageJson), androidToolsInfo || defaultAndroidToolsInfo);
        });
    }
}
